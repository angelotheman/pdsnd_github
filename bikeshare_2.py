...
def user_input(user_input,input_type):
    while True:
...
def get_filters():
    ...
    city = user_input("Would you like to see the data for chicago, new york city or washington?\n",'c')
    # get user input for month (all, january, february, ... , june), and check user input validity  
    month = user_input("For filtering data by specific mounth please enter month name from (january, february, march, april, may, june) otherwise enter 'all'\n", 'm')
    # get user input for day of week (all, monday, tuesday, ... sunday), and check user input validity
    day = user_input("For filtering data by specific day please enter day name from (sunday, monday, tuesday, wednesday, thursday, friday, saturday) otherwise enter 'all'\n", 'd')
...
def time_stats(df):
    ...
    print('Most Common Month is: ', commonest_month)

    #display the most common day of week
    most_popular_day = df['day_of_week'].mode()[0]
    print('Most Common Day Of Week is: ', most_popular_day)

    #display the most common start hour
    most_popular_hour = df['hour'].mode()[0]
    print('Most Common Start Hour Of Day is: ', most_popular_hour)
